...
namespace FactoryPlanner.Tests
{
    public class UserSettingsTests : IDisposable
    {
        ...
        [Fact]
        public void SearchCaseSensitive_RaisesSettingChangedEvent_WhenValueChanges() {
            UserSettings settings = CreateUserSettings();
            string? changedPropertyName = null;
            settings.SettingChanged += (name) => changedPropertyName = name;
            ...
            changedPropertyName.Should().Be(nameof(settings.SearchCaseSensitive));
        }

        [Fact]
        public void SearchSplitQuery_RaisesSettingChangedEvent_WhenValueChanges() {
            UserSettings settings = CreateUserSettings();
            string? changedPropertyName = null;
            settings.SettingChanged += (name) => changedPropertyName = name;
            ...
            changedPropertyName.Should().Be(nameof(settings.SearchSplitQuery));
        }

        [Fact]
        public void SearchCaseSensitive_DoesNotRaiseEvent_WhenSetToSameValue() {
            UserSettings settings = CreateUserSettings();
            int eventCount = 0;
            settings.SettingChanged += (name) => eventCount++;

            settings.SearchCaseSensitive = false;

            eventCount.Should().Be(0);
        }

        [Fact]
        public void SearchSplitQuery_DoesNotRaiseEvent_WhenSetToSameValue() {
            UserSettings settings = CreateUserSettings();
            int eventCount = 0;
            settings.SettingChanged += (name) => eventCount++;
        ...
        [Fact]
        public void SearchCaseSensitive_DefaultsToFalse() {
            UserSettings settings = CreateUserSettings();
        ...
        [Fact]
        public void SearchSplitQuery_DefaultsToTrue() {
            UserSettings settings = CreateUserSettings();
        ...
        [Fact]
        public void SearchSplitQuery_CanBeToggled() {
            UserSettings settings = CreateUserSettings();
        ...
        [Fact]
        public void SearchSettings_CanBeSetIndependently() {
            UserSettings settings = CreateUserSettings();
